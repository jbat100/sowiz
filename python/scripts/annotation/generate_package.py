...
from sowiz.description.package import PackageGenerator

if __name__ == '__main__':

	annotations = ["beat_spectral_diff.n3", 'rms_amplitude.n3', 'chronogram.n3', 'spectral_centroid.n3', 'constant_q_spect.n3']

	parser = argparse.ArgumentParser(description='Generate an description package')
	...
	annotation_config_path_components = script_path_components[:-3] + ['config', 'description']
